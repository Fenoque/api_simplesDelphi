...
begin
  LServiceGrupoProdutos := TServiceGrupoProduto.Create;
   try
      LServiceGrupoProdutos.LocalizarGrupoProdutoPorId(StrToInt(ARequest.Params['id-grp']));
...
begin
  THorse.Get('/grupoprodutos', ObtemGrupoProdutos);
  THorse.Get('/grupoproduto/:id-grp', ObterGrupoProdutoPorId);
  THorse.Put('/grupoproduto/:id-grp', AlterarGrupoProduto);
